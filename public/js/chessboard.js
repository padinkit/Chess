  ...
  for (var i = 0; i < 8; i++) {
    ...
    for (var j = 0; j < 8; j++) {
      ...
      html += '<div class="' + CSS.square + ' ' + CSS[squareColor] + ' ' +
        'square-' + square + '" ' +
        'style="width: ' + SQUARE_SIZE + 'px; height: ' + SQUARE_SIZE + 'px ; font-size: ' + SQUARE_SIZE/1.5 + 'px"'  +
...
function buildPiece(piece, hidden, id) {
  ...
  html += 'alt="" ' +
  'class="' + CSS.piece +' ' + pieceClassAdd(piece) + '" ' +
  'data-piece="' + piece + '" ' +
  'style="width: ' + SQUARE_SIZE + 'px;' +
  'height: ' + SQUARE_SIZE + 'px;' +
  'font-size: '  + SQUARE_SIZE/1.5 + 'px' ; 
  if (hidden === true) {
    html += 'display:none;';
  }
  html += '" ></div>';
...
function beginDraggingPiece(source, piece, x, y) {
  ...
  draggedPieceEl.attr('class', pieceClassAdd(piece))
    .css({
      display: '',
      position: 'absolute',
