$( document ).ready(function() {
	...
	var g_uiBoard;
	var size =  $('.chessboard').width() < $(window).height() ? $('.chessboard').width() : $(window).height();
	console.log(size);
	var g_cellSize = size/10;
	
	var fontsize = g_cellSize /1.5;
	function UINewGame() {
	    moveNumber = 1;
	    ...
	    for (y = 0; y < 8; ++y) {
	        for (x = 0; x < 8; ++x) {
	            ...
	            switch (piece & 0x7) {
	                ...
	                case pieceRook: pieceName = "tower"; break;
	            ...
	            if (pieceName != null) {
	                ...
	                $(img).addClass('glyphicon glyphicon-' + pieceName);
	...
	function RedrawBoard() {
	    ...
	    for (y = 0; y < 8; ++y) {
	        ...
	        for (x = 0; x < 8; ++x) {
	            ...
	            td.style.backgroundColor = ((y ^ x) & 1) ? "#827f7c" : "#FFF";
	            tr.appendChild(td);
	            g_uiBoard[y * 8 + x] = td;
	        }
